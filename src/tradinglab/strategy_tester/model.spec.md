...
- `@dataclass(frozen=True) class TestConfig` — full envelope: entry_strategy_id, exit_strategy_id, universe, start/end_date, interval, starting_cash, cost_model, date_preset, rng_seed, schema_version, user_label.
