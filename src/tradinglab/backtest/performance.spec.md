...
- `CSV_COLUMNS: Tuple[str, ...]` — canonical order: `order_id, entry_ts, entry_iso, exit_ts, exit_iso, holding_seconds, symbol, side, qty, entry_price, exit_price, pnl, pnl_pct, mae, mae_pct, mfe, mfe_pct, setup_tag, conviction, target, thesis, user_review, pre_screenshot, post_screenshot`.
