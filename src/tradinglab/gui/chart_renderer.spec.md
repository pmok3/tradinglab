...
- `class ChartRenderer`
  ...
  - `reset_slot_artists(slot)` — tear down cached artists for one slot (`price_wicks`, `price_bodies`, `vol_bars`, shading, event glyphs, volume-ToD overlays, and indicator state).
